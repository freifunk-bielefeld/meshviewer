  ...
  function (SortTable, V, d3Interpolate, moment, helper) {
    ...
    function showGeoURI(d) {
      ...
      return function (el) {
        ...
        a.textContent = Number(d.nodeinfo.location.latitude.toFixed(6)) + ' N, ' + Number(d.nodeinfo.location.longitude.toFixed(6)) + ' E';
    ...
    return function (config, el, router, d, gateways) {
      ...
      helper.attributeEntry(attributes, 'node.firmware', helper.dictGet(d.nodeinfo, ['software', 'firmware', 'release']));
